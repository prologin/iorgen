...
fun main() {
    ...
    var emptyList: List<Int> = reader.readLine().split(" ").map(String::toInt)
    var bufferString: String = reader.readLine()
    var n: Int = reader.readLine().toInt()
    var emptyInSample: List<Int> = reader.readLine().split(" ").map(String::toInt)
    ...
    var listInStruct: List<Int> = reader.readLine().split(" ").map(String::toInt)
